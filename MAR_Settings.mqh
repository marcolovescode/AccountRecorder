...
input bool OrderEquitySameDb = false; // Use same database for orders and equity
...
input string PgConnectEquityString = "hostaddr=127.0.0.1 port=5432 dbname=mydb user=username password=password connect_timeout=5";

input bool EnableSqlite = true;
input string SlOrderDbPath = "";
input string SlEquityDbPath = "";

input bool EnableSqlText = true;
input string TxOrderDbPath = "";
input string TxEquityDbPath = "";
