...
int sqlite3_prepare_v2(sqlite3_p64 aDb,const char &sql[],int nByte,sqlite3_stmt_p64 &pStmt,PTRPTR64 pzTail) { sqlite3_stmt_p32 pstmt=NULL; int r=sqlite3_32::sqlite3_prepare_v2(aDb,sql,nByte,pstmt,pzTail); pStmt=pstmt; return(r); }
int sqlite3_step(sqlite3_stmt_p64 apstmt) { return(sqlite3_32::sqlite3_step((sqlite3_stmt_p32)apstmt)); }
int sqlite3_finalize(sqlite3_stmt_p64 apstmt) { return(sqlite3_32::sqlite3_finalize((sqlite3_stmt_p32)apstmt)); }

int sqlite3_errcode(sqlite3_p64 db) { return(sqlite3_32::sqlite3_errcode((sqlite3_stmt_p32)db)); }
int sqlite3_extended_errcode(sqlite3_p64 db) { return(sqlite3_32::sqlite3_extended_errcode((sqlite3_stmt_p32)db)); }
const PTR64 sqlite3_errmsg(sqlite3_p64 db) { return(sqlite3_32::sqlite3_errmsg((sqlite3_stmt_p32)db)); }

int sqlite3_bind_null(sqlite3_stmt_p64 apstmt,int icol) { return(sqlite3_32::sqlite3_bind_null((sqlite3_stmt_p32)apstmt,icol)); }
int sqlite3_bind_int(sqlite3_stmt_p64 apstmt,int icol,int a) { return(sqlite3_32::sqlite3_bind_int((sqlite3_stmt_p32)apstmt,icol,a)); }
int sqlite3_bind_int64(sqlite3_stmt_p64 apstmt,int icol,long a) { return(sqlite3_32::sqlite3_bind_int64((sqlite3_stmt_p32)apstmt,icol,a)); }
int sqlite3_bind_double(sqlite3_stmt_p64 apstmt,int icol,double a) { return(sqlite3_32::sqlite3_bind_double((sqlite3_stmt_p32)apstmt,icol,a)); }
int sqlite3_bind_text(sqlite3_stmt_p64 apstmt,int icol,char &a[],int len,PTRPTR64 destr) { return(sqlite3_32::sqlite3_bind_text((sqlite3_stmt_p32)apstmt,icol,a,len,(PTRPTR32)destr)); }
int sqlite3_bind_blob(sqlite3_stmt_p64 apstmt,int icol,uchar &a[],int len,PTRPTR64 destr) { return(sqlite3_32::sqlite3_bind_blob((sqlite3_stmt_p32)apstmt,icol,a,len,(PTRPTR32)destr)); }

const PTR64 sqlite3_column_name(sqlite3_stmt_p64 apstmt,int icol) { return(sqlite3_32::sqlite3_column_name((sqlite3_stmt_p32)apstmt,icol)); }
int sqlite3_column_count(sqlite3_stmt_p64 apstmt) { sqlite3_stmt_p32 pstmt=(sqlite3_stmt_p32)apstmt; int r=sqlite3_32::sqlite3_column_count(pstmt); apstmt=pstmt; return(r); } 
int sqlite3_column_type(sqlite3_stmt_p64 apstmt,int acol) { return(sqlite3_32::sqlite3_column_type((sqlite3_stmt_p32)apstmt,acol)); }
int sqlite3_column_bytes(sqlite3_stmt_p64 apstmt,int acol) { return(sqlite3_32::sqlite3_column_bytes((sqlite3_stmt_p32)apstmt,acol)); }
int sqlite3_column_int(sqlite3_stmt_p64 apstmt,int acol) { return(sqlite3_32::sqlite3_column_int((sqlite3_stmt_p32)apstmt,acol)); }
long sqlite3_column_int64(sqlite3_stmt_p64 apstmt,int acol) { return(sqlite3_32::sqlite3_column_int64((sqlite3_stmt_p32)apstmt,acol)); }
